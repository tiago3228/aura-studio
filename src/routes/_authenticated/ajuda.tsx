...
const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Para configurar a agenda de um profissional, abra Equipe, localize o profissional e clique em Configurar agenda.",
      "Na tela Perfil e agenda, configure os dias de atendimento, início, fim e intervalo de almoço do profissional.",
      "Na seção Janelas extras deste profissional, clique em Adicionar janela e informe o início e o fim do período adicional.",
      "Escolha Livre para agendamento quando o profissional aceitar clientes nesse período. Escolha Bloqueada sem agendamento quando o período não deve oferecer horários.",
      "Clique em Salvar. Para um horário extra aparecer no link público, a clínica também precisa ter uma janela correspondente marcada como Livre para agendamento em Ajustes → Horários da clínica.",
    ...
    tips: [
      ...
      "Exemplo: para oferecer 20:00–22:00, crie essa janela como Livre na clínica e também no profissional. Se qualquer uma das duas estiver bloqueada, o horário não será oferecido.",
      "Almoço, bloqueios pontuais da Agenda, conflitos e a duração do procedimento continuam sendo respeitados mesmo nas janelas extras.",
    ],
  },
  {
